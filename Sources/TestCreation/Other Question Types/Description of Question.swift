...
public struct DescriptionOfQuestion: Codable {
    ...
    public init(ownerInternalName: String, question: Question, extraDescription: String = "") {
    ...
    public init(ownerInternalName: String, questionName: String, questionText: String, questionAnswer: String, questionInput: String, extraDescription: String = "") {
        self.creatorInternalName = ownerInternalName
